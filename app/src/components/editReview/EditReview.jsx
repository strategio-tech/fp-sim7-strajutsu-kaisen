...
const Reviews = ({ getMovieData }) => {
    ...
    useEffect(() => {
        fetch(`https://cmcors.onrender.com/http://cinemate-env.eba-xuvrv233.us-east-1.elasticbeanstalk.com/reviews/edit/reviewId?reviewId=${reviewId}`, {
            method: 'GET',
        })
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        fetch(`https://cmcors.onrender.com/http://cinemate-env.eba-xuvrv233.us-east-1.elasticbeanstalk.com/reviews/edit/reviewId?reviewId=${e.target.id}`, {
            method: 'POST',
